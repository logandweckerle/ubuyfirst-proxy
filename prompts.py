...
- AMBER/BALTIC AMBER PENDANTS: Gold is just the clasp (1-3g), amber is the pendant!
...
If title mentions: "Murano", "Millefiori", "glass", "crystal pendant", "stone pendant", "amber pendant", "Baltic amber":
- The PENDANT is glass/stone/amber, NOT gold!
- Gold is only the BAIL/CLASP (connector piece) = 0.5-3g
- Stated weight is TOTAL including heavy pendant material!

AMBER PENDANT TRAP:
"18k gold Baltic Amber pendant" = The AMBER is the pendant, gold is just the tiny clasp/bail!
- Amber is lightweight but BULKY - a large amber pendant is 90%+ amber by weight
- Gold clasp/bail on amber pendant = 1-3g MAX
- If listing shows "14k/18k amber pendant 8g" -> gold is ~2g, amber is ~6g
- INSTANT PASS unless price < $150 (clasp gold value only)

GLASS/AMBER PENDANT WEIGHTS:
