...
DEBUG_MODE = False
QUEUE_MODE = True  # Queue mode with ANALYZE button
...
def validate_and_fix_margin(result: dict, listing_price, category: str) -> dict:
    ...
    Recalculates margin from maxBuy - listingPrice and forces PASS if negative.
    """
    try:
        ...
        if abs(correct_margin - ai_margin) > 5:  # Allow $5 tolerance for rounding
            ...
            result['Margin'] = f"{correct_margin:+.2f}"
