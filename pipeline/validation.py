        ...
        if melt_value > 0:
            ...
            # Only override PASS to BUY if weight is VERIFIED (scale/stated).
                ...
                # Only consider overriding if weight is verified
                    ...
                    # SAFEGUARD: Don't override for items with significant gemstones
                    elif any(gem in title_lower for gem in ['diamond', 'emerald', 'ruby', 'sapphire', 'tcw', 'ctw', 'carat']):
                        logger.info(f"[CALC] KEEPING PASS - item has gemstones (weight may include stones)")
